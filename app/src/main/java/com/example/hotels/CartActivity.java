...
import com.example.hotels.Model.Cart;
import com.example.hotels.Prevalent.Prevalent;
import com.example.hotels.ViewHolder.CartViewHolder;
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder holder, int position, @NonNull final Cart model) {
                holder.txtProductQuantity.setText("Day Quantity=" + model.getQuantity());
                holder.txtProductPrice.setText("Price= R.S: " + model.getPrice());
